...
describe("Mint", function() {
    ...
    it("Can mint any number of times", async function() {
        for (let i = 0; i < 100; i++) {
            expect(
                await deployment.connect(user).donateAndMint(1, { value: ethers.utils.parseEther(`${10 * 0.024081991}`) })
            );
        }
    });
